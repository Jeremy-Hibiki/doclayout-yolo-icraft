...
from visualize import COCO_CLASSES, vis
from yolov10_utils import DFL, dist2bbox, letterbox, make_anchors, scale_boxes, v10postprocess, xywh2xyxy
...
# IMG_PATH = "../0_yolov10/ultralytics/assets/zidane.jpg"
...
conf_thres = 0.45
max_det = 300
bboxes, scores, labels = v10postprocess(
